...
def model_predection(test_image):
    ...
    #we are feeding the data as a batch to model so convert single to image to batch
...
if(app_mode == 'Home'):
    ...
    ### Get Started
    Click on the *Disease Recognition* page in the sidebar to upload an image and experience the power of our Plant Disease Recognition Syst
    ### About Us
...
#Prediction Page
    ...
    if(st.button("Predict")):
        with st.spinner("Please wait..."):
            ...
            result_index = model_predection(test_image)
